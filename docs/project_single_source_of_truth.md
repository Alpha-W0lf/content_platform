...
Image Generation (Google Gemini API): Uses the Google Gemini API to utilize Imagen 3 for generating images based on [image][/image] prompts extracted from the script. This is a key v1.0 feature.
